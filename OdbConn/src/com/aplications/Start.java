...
public class Start {
    public static void main(String[] args) throws IOException {
       ...
       //FAILED!  String[] MyDir = new String[]{"03", "04","05","06","07","08","09"};//"00","01","02",
       ...
       // String[] MyDir2 = new String[]{"20","21","22","23"};
        ...
        //for(int j=0; j<MyDir.length; j++){ // for loop failed! :"(
            ...
            String s1 = "E:\\Dataset\\archiveteam-twitter-stream-2016-10\\10\\01\\06";
            //s1 = "E:\\Dataset\\archiveteam-twitter-stream-2016-10\\10\\01\\00\\32.json.bz2";
            String s2 = "F:\\Codes\\Java\\OrientDB\\OdbConn\\src\\com\\temp\\temp.json";
